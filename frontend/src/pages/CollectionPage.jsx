...
//     const { collection } = useParams();
//     const [searchParams] = useSearchParams();
//     const searchParamsString = searchParams.toString(); // ✅ FIX: track param changes
//     const dispatch = useDispatch();
//     const { products, loading, error } = useSelector((state) => state.products);
...
//         dispatch(fetchProductsByFilters({ collection, ...queryParams }));
//     }, [dispatch, collection, searchParamsString]); // ✅ FIXED: now listens to real value change
...
//     // ✅ FIX: use searchParams.toString() to track filter/sort/color param changes
//     useEffect(() => {
//         const queryParams = Object.fromEntries([...searchParams.entries()]);
//         dispatch(fetchProductsByFilters({ collection, ...queryParams }));
